...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.rating_votes'
        db.add_column('courses_course', 'rating_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Course.rating_score'
        db.add_column('courses_course', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.rating_votes'
        db.delete_column('courses_course', 'rating_votes')

        # Deleting field 'Course.rating_score'
        db.delete_column('courses_course', 'rating_score')
